  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <h2 className="text-[32px] font-bold text-[#111827] tracking-tight mb-1">Tổng quan vườn cà phê</h2>
          <p className="text-[#6B7280] text-[15px] font-medium">Sức khỏe cây trồng và thông số môi trường thực tế</p>
        </div>
        <ZoneTabSwitcher />
      </div>
        ...
        <div className="flex-1 space-y-6 lg:space-y-8">
          ...
          <div className="mt-8">
            <div className="flex items-center mb-6">
              <svg className="w-5 h-5 text-[#245A34] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" />
              </svg>
              <h3 className="text-[20px] font-bold text-gray-900 tracking-tight">Thông số cảm biến IoT</h3>
            </div>
