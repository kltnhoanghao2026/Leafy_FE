...
export function CompletionRing({ completed, pending }: CompletionRingProps) {
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', minWidth: 0 }}>
        <h3 style={{ margin: 0, fontSize: '13px', fontWeight: 900, color: '#0f172a' }}>
          {t('plantManagement.overview.completionTitle')}
        </h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '11px', fontWeight: 700 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#e2e8f0', flexShrink: 0 }} />
