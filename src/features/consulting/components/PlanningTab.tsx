...
export function PlanningTab({ farmerProfileId }: { farmerProfileId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4 pt-6">
      <div className="flex items-center justify-between gap-2 flex-wrap">
        ...
        <button
          type="button"
          onClick={() => navigate(ROUTES.DASHBOARD.CONSULTING_CREATE_PLAN(farmerProfileId))}
          className="flex items-center gap-1.5 rounded-xl bg-[#245A34] px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[#1a4226]"
        >
