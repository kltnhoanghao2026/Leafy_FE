...
export function LoginForm () {
  ...
  return (
    <div className="flex flex-col justify-center w-full px-8 py-10 lg:px-16 lg:w-[480px]">
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-bold text-[#1a1f2c]">Chào mừng bác trở lại!</h2>
        <p className="text-sm font-medium text-slate-500">Hệ thống giám sát cà phê thông minh</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between mt-4">
          <label htmlFor="rememberMe" className="flex items-center gap-2 cursor-pointer group">
            ...
            <span className="text-sm font-medium text-slate-600 select-none">Ghi nhớ đăng nhập</span>
          </label>
          <a href="#" className="text-sm font-semibold text-[#245A34] hover:text-[#1b432a] transition-colors">
            Quên mật khẩu?
          </a>
        </div>
