...
import { FileText, Layers, Hash, Copy, Check } from "lucide-react";
...
export function ChunkPreviewPanel({
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      {/* Stats Bar */}
      <div className="shrink-0 flex flex-wrap items-center gap-4 p-4 bg-gradient-to-r from-emerald-50 to-teal-50/50 rounded-2xl border border-emerald-100/80 shadow-sm">
        ...
        <div className="flex items-center gap-1.5 text-xs text-slate-500 ml-auto bg-white/60 px-3 py-1.5 rounded-lg">
